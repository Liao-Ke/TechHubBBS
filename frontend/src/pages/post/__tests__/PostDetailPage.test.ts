...
const mockPost: PostVO = {
  ...
  summary: '测试摘要',
  author: { id: '10', username: 'author1', avatarUrl: '', role: 'USER', status: 1, createTime: '2025-01-01' },
  categoryId: 1,
  categoryName: '技术讨论',
  visibility: 0,
  type: 0,
...
const mockDivineComments: CommentVO[] = [
  {
    id: 'dc1',
    postId: '1',
    author: { id: '20', username: 'user1', avatarUrl: '', role: 'USER', status: 1, createTime: '2025-01-01' },
    content: '这是一条神评内容',
    parentId: null,
    replyTo: null,
    likeCount: 10,
    ...
    children: [
      {
        id: 'c2',
        postId: '1',
        author: { id: '30', username: 'user2', avatarUrl: '', role: 'USER', status: 1, createTime: '2025-01-01' },
        content: '子回复',
        parentId: 'c1',
        replyTo: null,
        likeCount: 0,
...
const mockRelatedPosts: RelatedPostVO[] = [
  { id: 'r1', postId: '2', title: '相关帖子1', similarity: 0.85 },
  { id: 'r2', postId: '3', title: '相关帖子2', similarity: 0.72 },
]
